...
# 	Blaze fireball
# 	Has a cooldown
item replace entity @s hotbar.0 with fire_charge[custom_name='{"color":"red","italic":false,"text":"Fireball"}',custom_data={FireCharge:1b},food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:1000000}]
scoreboard players set @s fireball.cooldown 0
scoreboard players set @s fireball.level 0
# Staff
# 	Stick with extra damage
item replace entity @s hotbar.1 with stick[custom_name='{"italic":false,"text":"Staff"}',item_name='"staff"',unbreakable={show_in_tooltip:false},fire_resistant={},attribute_modifiers={modifiers:[{id:"attack_damage",type:"generic.attack_damage",amount:1,operation:"add_value",slot:"mainhand"}],show_in_tooltip:false}]
